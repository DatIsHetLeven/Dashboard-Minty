        ...
        <div class="row">
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="col-md-12"><label class="labels">Client ID</label><input type="text" class="form-control" placeholder="experience" value=""></div> <br>
                    <div class="col-md-12"><label class="labels">Secret</label><input type="text" class="form-control" placeholder="additional details" value=""></div><br>
                    <div class="col-md-12"><label class="labels">Omschrijving</label><input type="text" class="form-control" placeholder="additional details" value=""></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center experience"><span>Woo koppeling</span></div><br>
                    <div class="col-md-12"><label class="labels">Host</label><input type="text" class="form-control" placeholder="experience" value=""></div> <br>
                    <div class="col-md-12"><label class="labels">Woo key</label><input type="text" class="form-control" placeholder="additional details" value=""></div><br>
                    <div class="col-md-12"><label class="labels">Secret</label><input type="text" class="form-control" placeholder="additional details" value=""></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="col-md-12"><label class="labels">API code</label><input type="text" class="form-control" placeholder="experience" value="wertgvftfdtgvghyhgftde45"></div> <br>
                </div>
            </div>
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Actieve verbindingen</h4>
                    </div>
                    <div class="row mt-2">
